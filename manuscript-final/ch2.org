...
and is typified by the systems produced by Ampex (www.ampex.com) and Studer
(www.studer.ch). These allowed producers to record multiple /tracks/ of audio
information which could be edited and mixed to taste. This unlocked significant
...
(VST), by Steinberg (www.steinberg.net), was responsible for bringing
...
programming language such as /Csound/ (www.csounds.com). Central to
...
abstractions provided here allowed for a more succinct and straightforward
