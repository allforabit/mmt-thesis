...
version of the library was developed that included extra functionality required
by SonicSketch.
...
* Footnotes
[fn:1] Webpack and Browserify are build tools that allow developers to use
